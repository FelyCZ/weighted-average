...
public class HelpDialogSubject extends DialogFragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        web.loadUrl(getString(R.string.assets_path) + "help_subject.html");
        Button btnOk = view.findViewById(R.id.help_dialog_btn_ok);
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PreferenceManager.getDefaultSharedPreferences(getContext()).edit().putBoolean("help_subject", true).apply();
                getDialog().dismiss();
            }
        });
        return view;
