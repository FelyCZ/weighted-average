...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE3 = "CREATE TABLE Marks3 (_id INTEGER PRIMARY " +
            "KEY, name STRING, mark DOUBLE, weight DOUBLE )";
    private static final String SQL_CREATE_TABLE4 = "CREATE TABLE Marks4 (_id INTEGER PRIMARY " +
            "KEY, name STRING, mark DOUBLE, weight DOUBLE )";
    private static final String SQL_CREATE_TABLE5 = "CREATE TABLE Marks5 (_id INTEGER PRIMARY " +
            "KEY, name STRING, mark DOUBLE, weight DOUBLE )";
